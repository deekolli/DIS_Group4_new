...
//CRUD - Create Starts
        ...
        public async Task<IActionResult> Create([Bind("fullName,parkCode,statenames,activitynames")] AddNewPark pk)
        {
            try
            {
...
//CRUD - Update Starts
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("fullName,parkCode,statenames,activitynames")] UpdatePark updatedpk)
        {
            try
            {
                if (ModelState.IsValid)
